...
async def _single_disambiguation_attempt(
    ...
    # Get full context (bidirectional - both before and after)
    # This allows better reasoning about what references point to
    modified_context = selected_item.original_context_item.context_for_llm
...
async def disambiguation_node(state: State) -> Dict[str, List[DisambiguatedContent]]:
    ...
    llm = get_llm(completions=COMPLETIONS, stage="claim_extractor.disambiguation")
